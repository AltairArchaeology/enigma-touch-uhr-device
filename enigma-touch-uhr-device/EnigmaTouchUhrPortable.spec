...
build_hook = Path(tempfile.gettempdir()) / 'enigma_touch_qt_build_timestamp.py'
...
version_file = write_windows_version_info(
    version=__version__,
    original_filename='EnigmaTouchUhrPortable.exe',
    file_description='Enigma Touch - Uhr Device (Qt)',
    suffix='qt',
)
